...
java -cp "bin\;lib\jade.jar" jade.Boot -agents BROKER:fishmarket.agents.broker.Broker(BUYER1);SELLER1:fishmarket.agents.seller.Seller(BROKER);BUYER1:fishmarket.agents.buyer.Buyer(9999)